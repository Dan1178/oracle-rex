# Generated by Django 5.1.7 on 2025-04-08 03:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('owner', models.CharField(max_length=100)),
                ('units', models.ManyToManyField(related_name='groundForces', to='core.groundunit')),
                ('structures', models.ManyToManyField(related_name='groundForces', to='core.structure')),
            ],
        ),
        migrations.CreateModel(
            name='Planet',
