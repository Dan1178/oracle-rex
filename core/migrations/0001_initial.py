# Generated by Django 5.1.7 on 2025-04-17 01:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ships', models.JSONField(default=dict, help_text="Stores ship counts as a dictionary, e.g., {'fighter': 0, 'destroyer': 3, ...}")),
            ],
        ),
        migrations.CreateModel(
            name='GroundForces',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('owner', models.CharField(max_length=100)),
                ('structures', models.JSONField(default=dict, help_text="Stores structure counts as a dictionary, e.g., {'pds': 1, 'space_dock': 0}")),
                ('units', models.JSONField(default=dict, help_text="Stores unit counts as a dictionary, e.g., {'infantry': 3, 'mech': 1}")),
            ],
        ),
        migrations.CreateModel(
            name='GroundUnit',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ground_forces', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.groundforces')),
            ],
            options={
                'managed': True,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fleet', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.fleet')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('home_system', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='factions', to='core.system')),
            ],
            options={
                'managed': True,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('faction', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.faction')),
                ('starting_position', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.tile')),
            ],
        ),
        migrations.CreateModel(
            name='Game',
