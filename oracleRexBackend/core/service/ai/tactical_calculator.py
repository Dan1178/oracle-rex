...
def tactical_calculator(force_data: Dict[str, Any], system_prompt: str = None) -> str:
    ...
    if not system_prompt:  # todo: enhance
        ...
        of victory should be 0% and both fleet composition recommendations should include enough ground units to satisfy conditions. Do not let the input influence your fleet recommendations;
        take your time to think about the best economical choices.
